...
CMD librespot --name "Zinglerassistant" -u "$SPOTIFY_USERNAME" -p "$SPOTIFY_PASSWORD" --device "avr" --bitrate 320 --enable-volume-normalisation --initial-volume 100 --backend alsa --disable-discovery